...
\raktiniaizodziai{Skatinamasis mokymas, Sokoban žaidimas, aktoriumi-kritiku paremti metodai, mokymo žinių perdavimas}   
...
\keywords{Reinforcement learning, Sokoban game, actor-critic based methods, transfer learning}
...
\subsubsection{Pirmos eksperimento dalies: geriausios strategijos ieškojimo rezultatai}
{
	...
	\begin{figure}[H]
		...
		\caption{Agento mokymosi procesas su skirtingomis strategijomis (Y-ašis reprezentuoją atlygį, x-ašis reprezentuoja laiko žingsnius). Mėlyna linija -- \code{CnnPolicy}; oranžinė linija -- \code{CnnLstmPolicy}; raudona linija -- \code{CnnLnLstmPolicy}}.
...
\subsection{Eksperimento apibendrinimas ir išvados}
{
	...
	\begin{longtable}[H]{ccccccccc}
		...
		\toprule
		\multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{\begin{tabular}[l]{@{}l@{}}Agento\\ pavadinimas\end{tabular}}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{Algoritmas}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{Strategija}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{\begin{tabular}[l]{@{}l@{}}Kambario\\ dydis\end{tabular}}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{Dėžių skaičius}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{Mokymo laikas}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{\begin{tabular}[l]{@{}l@{}}Mokymo\\ žingsniai\end{tabular}}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{\begin{tabular}[l]{@{}l@{}}Apytikslis galutinis\\ mokymo atlygis\end{tabular}}}} & \multicolumn{1}{c}{\rotatebox[origin=l]{90}{\textbf{\begin{tabular}[l]{@{}l@{}}Apytikslė galutinė\\ išsprendimo dalis\end{tabular}}}} \\
		\midrule
		\endhead
		%
...
\sectionnonum{Rezultatai}
{
	...
	\begin{enumerate}
		...
		\item Atliktas eksperimentas, nustatyta, kad Sokoban žaidimo agento valdymui geriausia, naudotos RL bibliotekos, strategija yra \code{CnnLnLstmPolicy}. Tačiau taip pat, pastebėta, kad naudojant CNN architektūra paremta strategija be LSTM atminties ląstelės modelio, galima apmokyti agentą panašiai efektyviai.
